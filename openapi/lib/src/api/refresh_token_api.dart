...
class RefreshTokenApi {
  ...
  const RefreshTokenApi(this._dio, this._serializers);
  ...
  Future<Response<TokenRefresh>> refreshTokenCreate({ 
    ...
    try {
      const _type = FullType(TokenRefresh);
    ...
    try {
      const _responseType = FullType(TokenRefresh);
